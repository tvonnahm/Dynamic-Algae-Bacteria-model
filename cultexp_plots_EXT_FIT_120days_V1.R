...
tspan <- seq(1, 120, 0.01) # time of model run in days (16)
...
pdf(file="FigS4_modpap_rev3.pdf")# width=600)
...
plot(texp, cexpmax, type='n', 
     ...
     xlab = "time [days]",ylim=c(0,12), xlim=c(0,120),
     axes=F)
axis(2, las=1, at=c(0,2,4,6,8,10,12))
axis(1, las=2, at=c(0,30,60,90,120))
...
plot(texp, nexpmax, type='n', 
     ...
     xlab = "time [days]", xlim=c(0,120),ylim=c(0,3),
     axes=F)
...
plot(texp, chlexpmax, type='n', 
     ...
     xlab = "time [days]", xlim=c(0,120),ylim=c(0,0.8),
     axes=F)
...
plot(tDINexp, DINexpmax, type='n', 
     ...
     xlab = "time [days]", ylim=c(0,120), xlim=c(0,120),
     axes=F)
...
plot(tnh4exp, nh4expmaxFull, type='n', 
     ...
     xlab = "time [days]", ylim=c(0,25), xlim=c(0,120), 
     axes=F)
...
plot(tdinexp, siexpmax, type='n', 
     ...
     xlab = "time [days]", ylim=c(0,30), xlim=c(0,120),
     axes=F)
