...
paramMod<-c(cost=cost, Rc=Rc, thetanmax=thetanmax, Qmin=Qmin, Qmax=Qmax, 
            ...
            ks=ks, Vmax=Vmax, smin=smin, rem=rem, remd=remd,
            mubact=mubact, bactmax=bactmax,
            kn2=kn2, nh4thres=nh4thres, SiPS= SiPS, xeps = xeps) 
pars<-paramMod
...
source('geider98v6_play.R')

x0 <- c(C0, Chl0, N0, DIN0, PSi0, Si0, bact0, 0, 0, don0, nh40, 0, 0, 0) # 
x <- x0
...
pdf(file="FigS1.1_modpap_rev3.pdf", width=12, height=6)
...
lines(tspan, out_axenic_noEX[,2]+out_axenic_noEX[,14], col="blue", lty="dotted", lwd=3)
lines(tspan, out_bact_noEX[,2]+out_bact_noEX[,14], col="red",lty="dotted", lwd=3)
legend("topleft", legend=c("BAC+ exp","BAC- exp", "EXT BAC+","EXT BAC-", "EXT +eps BAC+","EXT +eps BAC-"), 
...
lines(tspan, out_axenic_noEX[,4] + out_axenic_noEX[,15] , col="blue", lty="dotted", lwd=3)
lines(tspan, out_bact_noEX[,4] + out_bact_noEX[,15], col="red",lty="dotted", lwd=3)
...
cmod <- out_bact_noEX[c(1,101,201,301, 401, 501, 601, 701, 801, 901, 1001,  1301, 1401, 1501),2]+
  out_bact_noEX[c(1,101,201,301, 401, 501, 601, 701, 801, 901, 1001,  1301, 1401, 1501),14]
...
nmod <- out_bact_noEX[c(1,101,201,301, 401, 501, 601, 701, 801, 901, 1001,  1301, 1401, 1501),4]+
  out_bact_noEX[c(1,101,201,301, 401, 501, 601, 701, 801, 901, 1001,  1301, 1401, 1501),15]
